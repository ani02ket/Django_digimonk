# Generated by Django 4.1.4 on 2023-03-02 11:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address', models.TextField(blank=True, default=None)),
                ('city', models.CharField(default=None, max_length=75)),
                ('state', models.CharField(blank=True, default=None, max_length=20)),
                ('zip_code', models.CharField(blank=True, default=None, max_length=75)),
                ('phone_number', models.BigIntegerField(blank=True, verbose_name=True)),
                ('Exp_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('cvv', models.CharField(default=None, max_length=3)),
                ('cred_zipcode', models.CharField(default=None, max_length=75)),
            ],
        ),
        migrations.CreateModel(
            name='States',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('off_weekdays', models.ManyToManyField(to='api.weekdays')),
